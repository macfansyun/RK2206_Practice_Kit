...
typedef struct
{
    uint8_t io_select;        // spi io选择
    IoT_SPI_InitTypeDef *cfg; // spi 参数配置
} spi_dev_t;
...
extern void mfrc522_write_register(uint8_t addr, uint8_t val);
extern uint8_t mfrc522_read_register(uint8_t addr);
extern void mfrc522_set_bitmask(uint8_t reg, uint8_t mask);
extern void mfrc522_clear_bitmask(uint8_t reg, uint8_t mask);
...
extern void mfrc522_antenna_on(void);
extern void mfrc522_antenna_off(void);
extern void mfrc522_halt(void);

extern mfrc522_dev_t g_rc552_dev;
